...
import { X, CalendarPlus, CheckCircle2, ShieldAlert, Code2, ChevronRight, Users } from "lucide-react";
          ...
          <div className="p-6 md:p-8 flex flex-col gap-8">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start">
              ...
              <div className="flex flex-col flex-1">
                ...
                <p className="text-sm font-medium text-gray-500 mb-5">{activity.desc}</p>
                
                <div className="flex flex-col sm:flex-row gap-3">
                  <button className="flex-1 py-3 bg-gray-900 text-white font-bold rounded-xl text-sm flex justify-center items-center gap-2 hover:bg-gray-800 transition-colors shadow-sm">
                    <CalendarPlus className="w-4 h-4" /> 내 캘린더에 추가
                  </button>
                  <button className="px-5 py-3 border border-gray-200 text-gray-700 font-bold rounded-xl text-sm hover:bg-gray-50 transition-colors">
                    상세 모집요강
                  </button>
                </div>
              </div>
